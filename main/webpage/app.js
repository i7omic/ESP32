...
function getWifiConnectStatus()
{
    ...
    if(xhr.readyState == 4 && xhr.status == 200)
    {
        ...
        {
            document.getElementById("wifi_connect_status").innerHTML = "<h4 class='rd'>Failed to Connect. PLease check your AP credentals and compatibility</h4>";
...
{
    wifiConnectInterval = setInterval(getWifiConnectStatus, 2800); //every 2.8seconds
}
