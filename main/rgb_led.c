...
ledc_info_t ledc_ch[RBG_LED_CHANNEL_NUM]; 
...
/**
 * Initializes the RGB LED settings per channel, including the GPIO for each color,
 * mode and time configuration.
*/
static void rgb_led_pwm_init(void)
{
    ...
    // Configure channels
    for(rgb_ch = 0; rgb_ch < RBG_LED_CHANNEL_NUM; rgb_ch++)
    {
